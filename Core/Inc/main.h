...
/* Private defines -----------------------------------------------------------*/
#define USER_SW_Pin LL_GPIO_PIN_13
...
#define CONF_SW1_Pin LL_GPIO_PIN_3
#define CONF_SW1_GPIO_Port GPIOA
#define CONF_SW2_Pin LL_GPIO_PIN_4
#define CONF_SW2_GPIO_Port GPIOA
#define CONF_SW3_Pin LL_GPIO_PIN_5
#define CONF_SW3_GPIO_Port GPIOA
#define CONF_SW4_Pin LL_GPIO_PIN_6
#define CONF_SW4_GPIO_Port GPIOA
#define CONF_SW5_Pin LL_GPIO_PIN_7
#define CONF_SW5_GPIO_Port GPIOA
#define DEBUG_PIN_Pin LL_GPIO_PIN_2
#define DEBUG_PIN_GPIO_Port GPIOB
#define ADIS_nRST_Pin LL_GPIO_PIN_15
#define ADIS_nRST_GPIO_Port GPIOA
#define SPI1_nCS_Pin LL_GPIO_PIN_6
#define SPI1_nCS_GPIO_Port GPIOB
#define ADIS_DR_Pin LL_GPIO_PIN_7
#define ADIS_DR_GPIO_Port GPIOB
#define ADIS_DR_EXTI_IRQn EXTI4_15_IRQn
#define ADIS_SYNC_Pin LL_GPIO_PIN_8
